const codes = {
  ...
  // @note: @here: add pederson commitments requisite opcodes re: bluepaper (to_point opcode)
  0x21: ['TOPOINT', 0, 1, 1, false],
  // @note: @here: there should probably be a hamming weight opcode.
  // https://en.wikipedia.org/wiki/Hamming_weight
  // this would be useful for finding the number of bits set in a byte.
  ...
  // 0xb0 GETATTEST
  // get all attestations for an address, with a customized RLP dictionary
  // specifying trust anchor, jurisdiction, active status,
  ...
  // '0xb0' range - identity
  //get attestation.. returns a dictionary that contains all the attestations for this address
  0xe0: ['GETATTEST', 137, 2, 1, false, true],
  0xe1: ['GETREVOKE', 137, 2, 1, false, false],
  0xe2: ['CHECKATTESTVALID', 20, 2, 1, false, false],
